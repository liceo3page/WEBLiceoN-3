  ...
  contenedor.innerHTML = proyectos.slice(0, limite).map((proyecto) => `
    <article class="tarjeta-proyecto revelar">
      ...
      <div class="contenido-proyecto">
        ...
        <a class="enlace-tarjeta" href="/proyecto/?id=${proyecto.id}">Ver proyecto</a>
      </div>
    </article>
  `).join("");
}
  ...
  if (!proyecto) {
    contenedor.innerHTML = `
      <article class="detalle-comunicado revelar">
        ...
        <p>Puede haber sido movido o eliminado del listado.</p>
        <a class="boton boton-azul" href="/proyectos/">Volver a proyectos</a>
      </article>
    `;
    return;
  }
  ...
  if (!recurso) {
    contenedor.innerHTML = `
      <article class="detalle-comunicado revelar">
        ...
        <p>Puede haber sido movido o eliminado del listado.</p>
        <a class="boton boton-azul" href="/recursos/">Volver a recursos</a>
      </article>
    `;
    return;
  }
